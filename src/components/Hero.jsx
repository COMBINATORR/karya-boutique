...
export function Hero() {
  ...
  return (
    <div
      ref={containerRef}
      id="top"
      className="relative mb-[-1.75rem] h-[160vh] w-full bg-[var(--bg-dark)] min-[400px]:h-[175vh] sm:mb-[-2.25rem] sm:h-[190vh] lg:mb-[-2.75rem] lg:h-[210vh]"
    >
        ...
        >
          <div className="flex min-h-0 flex-1 flex-col items-center justify-center">
            <div className="flex w-full max-w-3xl flex-col items-center">
              ...
              <h1 className="animate-fade-up-delay-1 font-display font-bold leading-[0.96] tracking-[-0.035em] text-[var(--text-light)] text-[clamp(2.75rem,12vw,6rem)]">
                <ShinyText
              ...
              <div
                className="animate-fade-up-delay-2 mt-5 h-px w-12 bg-[var(--accent-cognac)]/90 sm:mt-6 sm:w-16"
                aria-hidden
              />
            </div>
          </div>
            ...
            <div className="mx-auto grid w-full max-w-xl grid-cols-3 gap-2 border-t border-[var(--text-light)]/15 pt-4 min-[400px]:gap-4 min-[400px]:pt-5 sm:gap-8 sm:pt-6">
              {stats.map((stat) => (
                <div key={stat.label} className="min-w-0 text-center">
                  <p className="font-display text-lg font-bold tracking-tight text-[var(--text-light)] min-[400px]:text-xl sm:text-3xl">
                    {stat.value}
                  </p>
                  <p className="mx-auto mt-0.5 max-w-[9rem] text-[8px] font-medium uppercase leading-snug tracking-[0.12em] text-[var(--text-light)]/50 min-[400px]:text-[9px] sm:mt-1 sm:text-[10px]">
                    {stat.label}
                  </p>
                </div>
              ))}
